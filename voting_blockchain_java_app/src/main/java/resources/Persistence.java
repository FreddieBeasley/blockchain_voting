...
import resources.util.FileHandlers;
import resources.util.JSONParsers.*; // BlockchainParser & NetworkParser
...
public class Persistence {
    ...
    // Initialisation
    public Persistence(String host, int port) { // default initialisation
        this.host = host;
        this.port = port;
    ...
    public Persistence(String persistentBlockchain, String persistentNetworkManager, String registeredVoters, String host, int port) { // custom initialisation
        this.host = host;
        this.port = port;
    ...
    private NetworkManager attemptNetworkManagerLoad() throws LoadException {
        ...
        try {
            networkManager = NetworkParser.JSONToNetworkManager(networkManagerJSON, host, port);
    ...
    private NetworkManager attemptNetworkManagerCreationWithOnlyKnownPeers() throws LoadException {
        try {
            return new NetworkManager(host, port, attemptKnownPeersLoad());
    ...
    private NetworkManager createNewNetworkManager() throws NoSuchAlgorithmException {
        return new NetworkManager(host, port, new KnownPeers());
    }
