...
import resources.network.resources.RemotePeer;
...
public class NetworkParser {
    ...
    public static NetworkManager  JSONToNetworkManager(JSONObject data, String host, int port) throws MalformedJSONException, NoSuchAlgorithmException {
        ...
        return new NetworkManager(host, port, knownPeers);
    }
